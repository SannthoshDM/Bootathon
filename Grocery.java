...
public class Grocery {
    ...
    public  Grocery()
    {
        ...
        Image icon = Toolkit.getDefaultToolkit().getImage("C:\\Users\\Sandy\\Pictures\\bootcamp project\\icon.jpg");
        f.setIconImage(icon);
        f.setTitle("farm fresh");
        f.setContentPane(new JLabel(new ImageIcon("C:\\\\\\\\Users\\\\\\\\Santhosh\\\\\\\\Documents\\\\\\\\boot camp--- java\\\\\\\\photos\\\\\\\\image67.jpg")));
