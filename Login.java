...
public class Login extends JFrame {
	...
	Login()
	{
		...
		//icon setting
		 Image icon = Toolkit.getDefaultToolkit().getImage("C:\\Users\\Santhosh\\Documents\\boot camp--- java\\photos\\lock.jpg");
		 setIconImage(icon);
		 
		//setContentPane(new JLabel(new ImageIcon("C:\\\\Users\\\\Santhosh\\\\Documents\\\\boot camp--- java\\\\photos\\\\strawberries-528791__340.jpg")));
		 ImageIcon iconss = new ImageIcon("C:\\\\Users\\\\Santhosh\\\\Documents\\\\boot camp--- java\\\\photos\\\\logo2.jpg");
	      JLabel labels = new JLabel(iconss);
	      labels.setBounds(400,0,500,500);
	      c.add(labels);
	      
//	      ImageIcon icons1 = new ImageIcon("C:\\\\Users\\\\Santhosh\\\\Documents\\\\boot camp--- java\\\\photos\\\\lock.jpg");
